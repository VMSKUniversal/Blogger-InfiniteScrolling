...
_WidgetManager._GetAllData().blog.pageType&&(e=a("a.blog-pager-older-link").attr("href"))){var f=a('<a href="javascript:;">Load More</a>');f.click(d);var h=a('<img src="https://lh3.googleusercontent.com/-FiCzyOK4Mew/T4aAj2uVJKI/AAAAAAAAPaY/x23tjGIH7ls/s32/ajax-loader.gif" style="display: none;">');g.scroll(b);c=a('<div style="text-align: center; font-size: 150%;"></div>');c.append(f);c.append(h);c.insertBefore(a("#blog-pager"));a("#blog-pager").hide()}})})(jQuery);
